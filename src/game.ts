...
export const levels: Level[] = [
  ...
  },
  {
    ...
    size: 6, start: {x: 0, y: 2}, goal: {x: 5, y: 3},
  ...
  },
  {
    ...
    size: 6, start: {x: 4, y: 1}, goal: {x: 0, y: 4},
    walls: [{x: 5, y: 1}, {x: 2, y: 3}, {x: 4, y: 4}], gems: [{x: 3, y: 1}], targetScore: 1,
  ...
  },
  {
    ...
    walls: [{x: 2, y: 4}, {x: 2, y: 2}, {x: 4, y: 1}], gems: [{x: 0, y: 3}, {x: 3, y: 0}], targetScore: 6,
    rules: {move: 1, collide: 'stop', collect: true, timer: 5, score: 1},
  },
  {
